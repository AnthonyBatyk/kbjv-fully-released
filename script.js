document.addEventListener("DOMContentLoaded", () => {
  ...
  function renderCalculatorLog(){
    ...
    calculatorItems.forEach((item,index)=>{
      const row=document.createElement("div");row.className="log-item";row.draggable=true;row.dataset.index=String(index);
      ...
      row.append(handle,text,remove);calcLog.append(row);
    });
  }
